			...
			<div class="col-sm-5">
				<div class="main">
					<div class="main-center">
						<h2>Nhâp Khách hàng tìm kiếm</h2>
						<br>
						<form class="" method="post" action="TTKhachHang">

							<div class="form-group">
								<label for="email">Nhập Tên khách hàng Hoặc Tài khoản.</label>
							...
							<tbody>
								<tr>
									...
									<td><div class="alert alert-success">
											<strong>${h.getTenKH()}</strong> ---- tk: ${h.getTenDN()}
										</div></td>
									<td><form class="" method="post" action="TTKhachHang?xoaKH=${h.getMaKH()}">
